module EncodingDotCom
  class VideoFormat < Format #:nodoc:
    ALLOWED_OUTPUT_FORMATS = %w{flv fl9 wmv 3gp mp4 m4v ipod iphone ipad android webm appletv psp zune wma m4a mpeg2 iphone_stream ipad_stream muxer wowza wowza_multibitrate roku}.freeze
